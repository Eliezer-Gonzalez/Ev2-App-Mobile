...
Solucionar problema de demora en guardar task sin foto. No debería pasar ya que es simplemente un label.
Estilizar interfaz. Asegurandome que este tenga un tema en general para toda la app.